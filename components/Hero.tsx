          ...
          <div className="space-y-8 animate-in slide-in-from-left duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                onClick={() => window.dataLayer.push({ event: 'cta_click', cta_location: 'hero', cta_text: 'Open Account' })}
              >
                Open Account
              ...
              <Button 
                ...
                onClick={() => window.dataLayer.push({ event: 'cta_click', cta_location: 'hero', cta_text: 'Learn More' })}
              >
                View Products
              </Button>
            </div>
